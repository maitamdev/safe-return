...
function LoginForm() {
  ...
  return (
    <div className="w-full max-w-md">
      ...
      <p className="mt-2 text-sm leading-6 text-ink-soft">Đăng nhập bằng email để bảo vệ dữ liệu. Sau khi vào ứng dụng, kết nối Phantom để ký giao dịch trên mạng thử nghiệm.</p>

      {!configured && <div className="alert-box-warn mt-5 rounded-xl p-4 text-sm"><p className="font-bold">Thiếu cấu hình đăng nhập</p><p className="mt-1 leading-6">Thêm biến môi trường theo <Link href="/setup" className="underline">hướng dẫn thiết lập</Link>.</p></div>}
